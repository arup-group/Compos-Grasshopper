...
namespace ComposGH.Parameters.Tests
{
  public partial class ComposBeamTest
  {
    ...
    public BeamSection TestConstructorProfile(string profile, double expDepth, double expTopFlangeWidth, double expBottomFlangeWidth, double expWebThickness, double expTopFlangeThickness, double expBottomFlangeThickness)
    {
    ...
    public void TestConstructorProfileExceptions(string profile)
    {
      // check that exceptions are thrown if inputs does not comply with allowed
      Assert.Throws<System.ArgumentException>(() => TestConstructorProfile(profile, 0, 0, 0, 0, 0, 0));
    }

    // 1 setup inputs
    [Theory]
    [InlineData(200, 190.5, 8.5, 12.7, false, 200, 190.5, 190.5, 8.5, 12.7, 12.7, "STD I 200 190.5 8.5 12.7")]
    public BeamSection TestConstructorSymmetric(
    ...
    public BeamSection TestConstructorAsymmetric(double depth, double topFlangeWidth, double bottomFlangeWidth,
    ...
    public BeamSection TestConstructorSymmetricCM(
      double depth, double flangeWidth, double webThickness, double flangeThickness, bool taperToNext,
      string expProfile)
    {
    ...
    public BeamSection TestConstructorAsymmetricCM(double depth, double topFlangeWidth, double bottomFlangeWidth,
      double webThickness, double topFlangeThickness, double bottomFlangeThickness, bool taperToNext,
      string expProfile)
    {
      LengthUnit unit = LengthUnit.Centimeter;
    ...
    [Fact]
    public void TestComposBeamDuplicate()
    {
      LengthUnit unit = LengthUnit.Millimeter;
