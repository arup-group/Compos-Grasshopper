...
{
  public class CreateStandardASNZSteelMaterial : GH_OasysComponent, IGH_VariableParameterComponent
  {
    ...
    private void UpdateUIFromSelectedItems()
    {
      ...
      {
        ASNZSteelMaterial mat = new ASNZSteelMaterial(this.SelectedItems[0]);
