...
namespace ComposGH.Components {
  public class CreateStandardENSteelMaterial : GH_OasysDropDownComponent {
    ...
    public CreateStandardENSteelMaterial() : base("StandardEN" + SteelMaterialGoo.Name.Replace(" ", string.Empty),
    ...
    protected override void SolveInstance(IGH_DataAccess DA) {
      ...
      if (Params.Input[0].Sources.Count > 0) {
        ...
        try {
          ...
          var gradesEN = Enum.GetValues(typeof(StandardSteelGrade)).Cast<StandardSteelGrade>().Select(x => x.ToString()).ToList();
          gradesEN.RemoveAt(3);
