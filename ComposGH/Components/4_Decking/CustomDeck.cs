...
namespace ComposGH.Components
{
    public class CustomDeck : GH_Component, IGH_VariableParameterComponent
    {
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddGenericParameter("B1 [" + unitAbbreviation + "]", "B1", "Lenght of b1 deck parameter. See the decking picture in helps", GH_ParamAccess.item);
            pManager.AddGenericParameter("B2 [" + unitAbbreviation + "]", "B2", "Lenght of b2 deck parameter. See the decking picture in helps", GH_ParamAccess.item);
            pManager.AddGenericParameter("B3 [" + unitAbbreviation + "]", "B3", "Lenght of b3 deck parameter. See the decking picture in helps", GH_ParamAccess.item);
            pManager.AddGenericParameter("B4 [" + unitAbbreviation + "]", "B4", "Lenght of b4 deck parameter. See the decking picture in helps", GH_ParamAccess.item);
            pManager.AddGenericParameter("B5 [" + unitAbbreviation + "]", "B5", "Lenght of b5 deck parameter. See the decking picture in helps", GH_ParamAccess.item);
