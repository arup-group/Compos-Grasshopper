...
namespace ComposGH.Components {
  public class CreateStud : GH_OasysDropDownComponent {
    ...
    public CreateStud() : base("Create" + StudGoo.Name.Replace(" ", string.Empty), StudGoo.Name.Replace(" ", string.Empty), "Create a " + StudGoo.Description + " for a " + MemberGoo.Description, Ribbon.CategoryName.Name(), Ribbon.SubCategoryName.Cat2()) {
    ...
    protected override void SolveInstance(IGH_DataAccess DA) {
      var studDimensionsGoo = (StudDimensionsGoo)Input.GenericGoo<StudDimensionsGoo>(this, DA, 0);
      ...
      var studSpec = (StudSpecificationGoo)Input.GenericGoo<StudSpecificationGoo>(this, DA, 1);
      if (studSpec == null) {
        // return here on non-optional inputs
        return;
      }
      ...
      switch (SpacingType) {
        ...
        case StudSpacingType.Min_Num_of_Studs:
          ...
          Output.SetItem(this, DA, 0, new StudGoo(
              new Stud(studDimensions, studSpec.Value, minSav, SpacingType)));
          break;
        ...
        case StudSpacingType.Partial_Interaction:
          ...
          Output.SetItem(this, DA, 0, new StudGoo(
              new Stud(studDimensions, studSpec.Value, minSav, interaction)));
          break;
        ...
        case StudSpacingType.Custom:
          ...
          Output.SetItem(this, DA, 0, new StudGoo(
              new Stud(studDimensionsGoo.Value, studSpec.Value, spacings?.Select(x => x.Value as IStudGroupSpacing).ToList(), check)));
          break;
      }
    }
