...
namespace ComposGH.Components {
  public class CreateCustomStudDimensions : GH_OasysDropDownComponent {
    ...
    public CreateCustomStudDimensions() : base("Custom" + StudDimensionsGoo.Name.Replace(" ", string.Empty), "StudDimsCustom", "Create a Custom " + StudDimensionsGoo.Description + " for a " + StudGoo.Description, Ribbon.CategoryName.Name(), Ribbon.SubCategoryName.Cat2()) {
