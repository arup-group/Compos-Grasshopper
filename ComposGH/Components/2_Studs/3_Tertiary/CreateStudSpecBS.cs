...
namespace ComposGH.Components {
  public class CreateStudSpecBS : GH_OasysDropDownComponent {
    ...
    public CreateStudSpecBS() : base("StandardBS" + StudSpecificationGoo.Name.Replace(" ", string.Empty), "StudSpecsBS", "Look up a Standard BS " + StudSpecificationGoo.Description + " for a " + StudGoo.Description, Ribbon.CategoryName.Name(), Ribbon.SubCategoryName.Cat2()) {
    ...
    protected override void SolveInstance(IGH_DataAccess DA) {
      ...
      var specBS = new StudSpecification(ec4, noStudZoneStart, noStudZoneEnd);
