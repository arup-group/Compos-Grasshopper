...
{
  public class StudSpecBS : GH_Component, IGH_VariableParameterComponent
  {
    ...
    public StudSpecBS()
      : base("Stud BS Specification", "StudSpecBS", "Create Stud Specification to BS5950-3-1 for a Compos Stud",
