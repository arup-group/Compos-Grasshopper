...
namespace ComposGH.Components {
  public class CreateBeamSizeLimits : GH_OasysDropDownComponent {
    ...
    public CreateBeamSizeLimits() : base("Create" + BeamSizeLimitsGoo.Name.Replace(" ", string.Empty),
