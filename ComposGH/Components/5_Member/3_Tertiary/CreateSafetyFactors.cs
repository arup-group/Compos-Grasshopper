...
namespace ComposGH.Components {
  public class CreateSafetyFactors : GH_OasysComponent {
    ...
    public CreateSafetyFactors() : base("Create" + SafetyFactorsGoo.Name.Replace(" ", string.Empty),
    ...
    protected override void SolveInstance(IGH_DataAccess DA) {
      ...
      var sf = new SafetyFactors() { LoadFactors = lf, MaterialFactors = mf };
