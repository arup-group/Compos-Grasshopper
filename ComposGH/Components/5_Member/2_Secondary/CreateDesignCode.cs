...
namespace ComposGH.Components {
  public class CreateDesignCode : GH_OasysDropDownComponent {
    ...
    public CreateDesignCode() : base("Create" + DesignCodeGoo.Name.Replace(" ", string.Empty),
    ...
    public override bool Read(GH_IO.Serialization.GH_IReader reader) {
      ...
      var newcheckboxes = new List<bool>();
    ...
    protected override void InitialiseDropdowns() {
      ...
      Checkboxes = new List<bool> {
        DesignOptions.ProppedDuringConstruction,
        DesignOptions.InclSteelBeamWeight,
        DesignOptions.InclThinFlangeSections,
        DesignOptions.InclConcreteSlabWeight,
        DesignOptions.ConsiderShearDeflection,
        EC4CodeOptions.ConsiderShrinkageDeflection,
        EC4CodeOptions.IgnoreShrinkageDeflectionForLowLengthToDepthRatios,
        EC4CodeOptions.ApproxModularRatios
      };
    ...
    protected override void SolveInstance(IGH_DataAccess DA) {
      ...
      if (Code == Code.EN1994_1_1_2004) {
        ...
        ec4safetyFactors = ec4safetyFactorsGoo?.Value;
      } else {
        safetyFactorsGoo = (SafetyFactorsGoo)Input.GenericGoo<SafetyFactorsGoo>(this, DA, 0);
        safetyFactors = safetyFactorsGoo?.Value;
      }
      ...
      switch (Code) {
        ...
        case Code.EN1994_1_1_2004:
          var ec4 = new EN1994 {
            NationalAnnex = NA,
            DesignOption = DesignOptions,
            CodeOptions = EC4CodeOptions
          };

          var shrink = (CreepShrinkageParametersGoo)Input.GenericGoo<CreepShrinkageParametersGoo>(this, DA, 1);
          if (shrink != null) {
            ec4.CodeOptions.ShortTerm = shrink.Value;
          }
          var longt = (CreepShrinkageParametersGoo)Input.GenericGoo<CreepShrinkageParametersGoo>(this, DA, 2);
          if (longt != null) {
