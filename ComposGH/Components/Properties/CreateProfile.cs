...
namespace ComposGH.Components
{
    ...
    public class CreateProfile : GH_OasysComponent, IGH_VariableParameterComponent
    {
        ...
        public override Guid ComponentGuid => new Guid("422FECDA-5B23-4273-A443-5D841981C922");
        public CreateProfile()
          : base("Create Profile", "Profile", "Create Profile text-string for Compos Section",
        ...
        protected override System.Drawing.Bitmap Icon => ComposGH.Properties.Resources.CreateProfile;
        #endregion
        ...
        {
            ComposProfile profile = new ComposProfile();
            ...
            if (_mode == FoldMode.Catalogue)
            {
                ...
                profile.profileType = ComposProfile.ProfileTypes.Catalogue;
            ...
            {
                profile.profileType = Helpers.ComposProfile.ProfileTypes.Geometric;
                ...
                if (DA.GetData(0, ref gh_Brep))
                {
                    ...
                    if (GH_Convert.ToBrep(gh_Brep, ref brep, GH_Conversion.Both))
                    {
                        ...
                        profile.geoType = Helpers.ComposProfile.GeoTypes.Perim;
            ...
            {
                profile.profileType = Helpers.ComposProfile.ProfileTypes.Standard;
                ...
                switch (selections[1])
                {
                    ...
                    case "Rectangle":
                        profile.stdShape = Helpers.ComposProfile.StdShapeOptions.Rectangle;
                    ...
                    case "Circle":
                        profile.stdShape = Helpers.ComposProfile.StdShapeOptions.Circle;
                        ...
                        break;
                    case "I section":
                        profile.stdShape = Helpers.ComposProfile.StdShapeOptions.I_section;
                        ...
                        break;
                    case "Tee":
                        profile.stdShape = Helpers.ComposProfile.StdShapeOptions.Tee;
                        // 0 d
                        DA.GetData(0, ref gh_d);
                        ...
                        break;
                    case "Channel":
                        profile.stdShape = Helpers.ComposProfile.StdShapeOptions.Channel;
                        // 0 d
                        DA.GetData(0, ref gh_d);
                        ...
                        break;
                    case "Angle":
                        profile.stdShape = Helpers.ComposProfile.StdShapeOptions.Angle;
                        // 0 d
                        DA.GetData(0, ref gh_d);
            ...
            {
                case "mm":
                    profile.sectUnit = Helpers.ComposProfile.SectUnitOptions.u_mm;
                    break;
                case "cm":
                    profile.sectUnit = Helpers.ComposProfile.SectUnitOptions.u_cm;
                    break;
                case "m":
                    profile.sectUnit = Helpers.ComposProfile.SectUnitOptions.u_m;
                    break;
                case "in":
                    profile.sectUnit = Helpers.ComposProfile.SectUnitOptions.u_in;
                    break;
                case "ft":
                    profile.sectUnit = Helpers.ComposProfile.SectUnitOptions.u_ft;
                    break;
            }
            #endregion
