...
//  public class CreateMemberLoad : GH_OasysDropDownComponent {
...
//    public CreateMemberLoad()
//              : base("CreateMemberLoad", "MemberLoad", "Create a Member Load.",
...
//      var constDead = (Force)Input.UnitNumber(this, DA, 0, _forceUnit);
//      var constLive = (Force)Input.UnitNumber(this, DA, 1, _forceUnit);
//      var finalDead = (Force)Input.UnitNumber(this, DA, 2, _forceUnit);
//      var finalLive = (Force)Input.UnitNumber(this, DA, 3, _forceUnit);
//      IQuantity pos = Input.LengthOrRatio(this, DA, 4, _lengthUnit);

//      Load load = new MemberLoad(constDead, constLive, finalDead, finalLive, pos);
