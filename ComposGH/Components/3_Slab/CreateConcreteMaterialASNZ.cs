...
namespace ComposGH.Components
{
  public class CreateConcreteMaterialASNZ : GH_Component, IGH_VariableParameterComponent
  {
    ...
    public CreateConcreteMaterialASNZ()
      : base("Concrete Material AS/NZ", "ConcMatASNZ", "Create concrete material (AS/NZ) for concrete slab",
    ...
    private ConcreteMaterial.ConcreteGrade Grade = ConcreteMaterial.ConcreteGrade.C20;
