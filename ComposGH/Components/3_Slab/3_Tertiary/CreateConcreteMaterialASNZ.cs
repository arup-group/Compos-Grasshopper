...
namespace ComposGH.Components {
  public class CreateConcreteMaterialASNZ : GH_OasysDropDownComponent {
    ...
    public CreateConcreteMaterialASNZ() : base("ASNZ" + ConcreteMaterialGoo.Name.Replace(" ", string.Empty),
    ...
    protected override void SolveInstance(IGH_DataAccess DA) {
      ...
      var shrinkageStrain = new Strain(-0.85, StrainUnit.MilliStrain);
      ...
      var concreteMaterial = new ConcreteMaterial(Grade, dryDensity, userDensity, (eRatio == null) ? new ERatio() : eRatio.Value, imposedLoadPercentage, shrinkageStrain, userStrain);
