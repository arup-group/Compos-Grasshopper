...
namespace ComposGH.UI
{
    ...
    public class MultiDropDown : GH_ComponentAttributes
    {
        public MultiDropDown(GH_Component owner, Action<int, int> clickHandle, List<List<string>> dropdownContents, List<string> selections, List<string> spacerTexts = null, List<string> initialdescriptions = null) : base(owner)
        {
        ...
        protected override void Render(GH_Canvas canvas, System.Drawing.Graphics graphics, GH_CanvasChannel channel)
        {
            ...
            if (channel == GH_CanvasChannel.Objects)
            {
                ...
                for (int i = 0; i < dropdownlists.Count; i++)
                {
                    ...
                    // background
                    Brush background = new SolidBrush(UI.Colour.GsaLightBlue);
                    // background
                    ...
                    if (unfolded[i])
                    {
                        ...
                        Brush dropdownbackground = new SolidBrush(UI.Colour.GsaLightBlue);
