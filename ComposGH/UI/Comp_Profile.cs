...
namespace ComposGH.UI
{
    ...
    public class ProfileComponentUI : GH_ComponentAttributes
    {
        ...
        float MinWidth
        {
            get
            {
                float sp = ComposGH.UI.ComponentUI.MaxTextWidth(spacerTxts, new Font(GH_FontServer.FamilyStandard, 7));
                float dd1 = ComposGH.UI.ComponentUI.MaxTextWidth(dropdownlists[0], new Font(GH_FontServer.FamilyStandard, 7));
                float dd2 = 0;
                if (dropdownlists.Count > 1)
                    dd2 = (displayTexts[0] == "Geometric") ? 0 : ComposGH.UI.ComponentUI.MaxTextWidth(dropdownlists[1], new Font(GH_FontServer.FamilyStandard, 7));
                float dd3 = 0; 
                if (dropdownlists.Count > 2)
                    dd3 = (displayTexts[0] == "Catalogue") ? ComposGH.UI.ComponentUI.MaxTextWidth(dropdownlists[2], new Font(GH_FontServer.FamilyStandard, 7)) : 0;
        ...
        protected override void Render(GH_Canvas canvas, System.Drawing.Graphics graphics, GH_CanvasChannel channel)
        {
            ...
            if (channel == GH_CanvasChannel.Objects)
            {
                ...
                if (displayTexts[0] == "Catalogue")
                {
                    ...
                    inclSsTxtBounds.Width = ComposGH.UI.ComponentUI.MaxTextWidth(incl, font);
