...
namespace ComposGH.Parameters
{
  ...
  public class SteelMaterialParam : GH_Param<SteelMaterialGoo>
  {
    ...
    { }
    public override string InstanceDescription => this.m_data.DataCount == 0 ? "Empty " + SteelMaterialGoo.Name + " parameter" : base.InstanceDescription;
    public override string TypeName => this.SourceCount == 0 ? SteelMaterialGoo.Name : base.TypeName;
