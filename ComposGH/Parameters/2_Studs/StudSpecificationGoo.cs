...
namespace ComposGH.Parameters {
  ...
  public class StudSpecificationParam : GH_Param<StudSpecificationGoo> {
    ...
    public StudSpecificationParam() : base(new GH_InstanceDescription(StudSpecificationGoo.Name, StudSpecificationGoo.NickName, StudSpecificationGoo.Description + " parameter",
        Components.Ribbon.CategoryName.Name(), Components.Ribbon.SubCategoryName.Cat10())) { }
  }
}
