  ...
  public class WebOpening
  {
    ...
    public override string ToString()
    {
      ...
      switch (this.WebOpeningType)
      {
        ...
        case OpeningType.End_notch:
        case OpeningType.Rectangular:
          size = this.Width.As(Helpers.Units.FileUnits.LengthUnitSection).ToString("f0") + "x" + this.Height.ToUnit(Helpers.Units.FileUnits.LengthUnitSection).ToString("f0").Replace(" ", string.Empty);
          break;
        case OpeningType.Circular:
          size = "Ø" + this.Diameter.ToUnit(Helpers.Units.FileUnits.LengthUnitSection).ToString("f0").Replace(" ", string.Empty);
          break;
      }
      ...
      switch (this.WebOpeningType)
      {
        ...
        case OpeningType.Rectangular:
        case OpeningType.Circular:
          typ = ", Pos:(x:" + this.CentroidPosFromStart.As(Helpers.Units.FileUnits.LengthUnitGeometry).ToString("f0") + ", z:" + this.CentroidPosFromTop.ToUnit(Helpers.Units.FileUnits.LengthUnitSection).ToString("f0").Replace(" ", string.Empty) + ")";
          break;
      }
      if (this.OpeningStiffeners != null)
        typ += " w/Stiff.";
