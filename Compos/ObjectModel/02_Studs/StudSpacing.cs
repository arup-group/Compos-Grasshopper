...
namespace ComposAPI.Studs
{
  ...
  public class StudGroupSpacing
  {
    ...
    {
      string start = (this.DistanceFromStart.Value == 0) ? "" : "From:" + this.DistanceFromStart.ToUnit(Helpers.Units.FileUnits.LengthUnitGeometry).ToString("f0").Replace(" ", string.Empty);
