...
namespace ComposAPI {
  ...
  public class StudSpecification : IStudSpecification {
    ...
    private IQuantity _EndPosition = Length.Zero;
    private IQuantity _StartPosition = Length.Zero;
    ...
    public override string ToString() {
      ...
      string ec4 = (Ec4Limit == true) ? "EC4 Limit" : "";
